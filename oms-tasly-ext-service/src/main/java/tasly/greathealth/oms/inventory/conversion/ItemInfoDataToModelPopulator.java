...
import tasly.greathealth.oms.api.inventory.dto.InventoryInnerSource;
 ...
 */
public class ItemInfoDataToModelPopulator extends AbstractPopulator<ItemInfoData, ItemInfo>
{
	@Override
	public void populate(final ItemInfoData source, final ItemInfo target)
	{
		...
		{
			target.setInnerSource(InventoryInnerSource.valueOf(source.getInnerSource().toString()));
		}
