 ...
 *
 */
public class TaslyShippingAndHandlingReversePopulator extends
		AbstractPopulator<TaslyShippingAndHandling, TaslyShippingAndHandlingData>
{
	@Override
	public void populate(final TaslyShippingAndHandling source, final TaslyShippingAndHandlingData target)
