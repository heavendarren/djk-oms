...
/**
 * Implementation of {@link AbstractPopulator} to populate a {@link SkuToProduct} from {@link SkuToProductData}.
 */
public class SkuToProductModelToDataPopulator extends AbstractPopulator<SkuToProduct, SkuToProductData>
{
	@Override
	public void populate(final SkuToProduct source, final SkuToProductData target)
	{
