 ...
 */
package tasly.greathealth.oms.service;
...
import tasly.greathealth.oms.api.DummyObjectFacade;
import tasly.greathealth.oms.api.dto.DummyObject;


@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration({"classpath*:oms-tasly-ext-service-test-spring.xml"})
